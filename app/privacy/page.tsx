export const metadata = {
  title: 'Privacy Policy - Flexus Net',
  description: 'Privacy Policy for Flexus Net - IT MSP Services',
}
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Flexus Net ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              ...
              <li>To communicate with you about your requests, services, and updates</li>
              <li>To match you with qualified technicians</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              <li><strong>Service Providers:</strong> We share information with technicians and service providers who perform services on our behalf</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              To exercise these rights, please contact us at <a href="mailto:service@flexusnet.com" className="text-primary-600 hover:underline">service@flexusnet.com</a>.
            </p>
          </section>
