        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center group">
              <div className="flex-shrink-0 w-12 h-12 bg-neon-cyan/10 rounded-lg flex items-center justify-center mr-4 border border-neon-cyan/30 group-hover:border-neon-cyan group-hover:bg-neon-cyan/20 transition-all duration-300">
